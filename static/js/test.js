(function() {
  ...
  var css = {
    ...
    title = function(args) {
      console.log("                        %c @ " + args, css.title);
    },

    content = function(args) {
      console.log("                        %c Test:" + args, css.content);
    },

    consequence = function(args) {
    ...
    InterviewsTeller = function(args) {
      ...
      if ((Array.isArray(args)) || (args.constructor.toString().indexOf("Array") > -1)) {
        ...
        args.forEach(function(interview, index) {
          if (interview.where) {
            title(interview.where);
          }

          if (interview.what) {
            if (!Array.isArray(interview.what)) {
              content(interview.what);
            } else {
              interview.what.forEach(function(m) {
                content(m);
              });
            }
          }
  ...
  */
  ...
  var interviews = [{
    ...
    what: [' 1. Array handling with some math ', ' 2. Duplicate handling in Arrays var obj:{}; function([],value){ [].forEach(function(v){ if(obj[m]){return m;}else{ obj[m]=true;}})} '],
    whyNot: 'RH part of the Interview went really wrong.'
  }, {
    where: 'Semiologic for Graphcomment.com, September 21',
